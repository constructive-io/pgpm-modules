...
INSERT INTO inflection.inflection_rules (
  ...
  ('singular', 'selves$', 'self'),
  ('singular', 'shelves$', 'shelf'),
  ('singular', '(^|[^[:alpha:]])elves$', E'\\1elf'),
  ('singular', 'knives$', 'knife'),
  ('singular', 'wives$', 'wife'),
  ('singular', '(^|[^o])lives$', E'\\1life'),
  ('singular', '(^|[^c])leaves$', E'\\1leaf'),
  ('singular', 'calves$', 'calf'),
  ('singular', 'dwarves$', 'dwarf'),
  ('singular', 'halves$', 'half'),
  ('singular', 'hooves$', 'hoof'),
  ('singular', 'loaves$', 'loaf'),
  ('singular', 'scarves$', 'scarf'),
  ('singular', 'sheaves$', 'sheaf'),
  ('singular', 'thieves$', 'thief'),
  ('singular', 'wharves$', 'wharf'),
