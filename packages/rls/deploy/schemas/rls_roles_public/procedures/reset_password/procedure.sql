-- Deploy: schemas/rls_roles_public/procedures/reset_password/procedure to pg
...
CREATE FUNCTION "rls_roles_public".reset_password (role_id uuid, reset_token text, new_password text)
    RETURNS boolean
AS $$
DECLARE
