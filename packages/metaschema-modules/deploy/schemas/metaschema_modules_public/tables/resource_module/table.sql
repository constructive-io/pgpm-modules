...
CREATE TABLE metaschema_modules_public.resource_module (
    ...
    -- Which BuildKit installation a namespace builds on, per lane. Generated
    -- here because its namespace FK is local while the installation may be
    -- owned by another resource scope.
    ...
    CONSTRAINT resource_module_builder_bindings_table_fkey FOREIGN KEY (builder_bindings_table_id) REFERENCES metaschema_public.table (id) ON DELETE CASCADE,
