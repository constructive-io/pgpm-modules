-- Deploy schemas/metaschema_modules_public/tables/content_preset_module/table to pg
...
CREATE TABLE metaschema_modules_public.content_preset_module (
    ...
    CONSTRAINT content_presets_table_fkey FOREIGN KEY (content_presets_table_id) REFERENCES metaschema_public.table (id) ON DELETE CASCADE,
    CONSTRAINT content_preset_module_entity_table_fkey FOREIGN KEY (entity_table_id) REFERENCES metaschema_public.table (id) ON DELETE CASCADE,
    CONSTRAINT content_preset_module_database_merkle_unique UNIQUE (database_id, merkle_store_module_id)
);
